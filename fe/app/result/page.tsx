    ...
    <>
      ...
      <div className="flex min-h-screen flex-row items-center justify-center text-xl">
        <div className="flex-1 flex-col items-center justify-between text-center px-16">
          <div className="text-3xl">프론트엔드 개발자</div>
          <Image
            src="/sample.png"
            width={480}
            height={480}
          ...
          />
          <div className="">프론트엔드 개발에 소질이 있으시군요!</div>
          <div className="">프론트엔드는 웹페이지의 화면을 구현하는 직무입니다.</div>
        </div>

        <div className="flex-1 flex-col items-center justify-between px-16 text-center text-xl ">
          <div className=" text-2xl p-8">
            <div>적성 점수는 70점입니다.</div>
          </div>

          <div className="flex flex-col text-center p-8">
            <div>관련 스택으로는</div>
            <div className="py-2 text-2xl"> HTML, CSS, JAVASCRIPT, REACT.JS, NEXT.JS TAILWIND</div>
            <div>등이 있습니다.</div>
          </div>
          <div className="flex flex-col text-center p-8">
            <div>지원해볼만한 회사는</div>
